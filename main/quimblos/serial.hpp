...
namespace qb {
    ...
    namespace serial {
        ...
        inline uint8_t chhex(const char& ch) {
            switch (ch) {
                case '0': return 0;
                case '1': return 1;
                case '2': return 2;
        ...
        inline std::string dump(const serial::Schema& schema, uint8_t kind) {
        ...
        inline void parse(const serial::Schema& schema, const std::string& payload) {
